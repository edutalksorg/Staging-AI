        ...
        <div className="space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <div className="card text-center p-6">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white">{t('referrals.tier1')}</h3>
                            ...
                            {history.length > 0 ? (
                                history.map((item, i) => (
                                    <tr key={i} className="text-sm">
                                        <td className="py-3 px-4 font-medium text-slate-900 dark:text-white">{item.refereeName || t('referrals.anonymousUser')}</td>
